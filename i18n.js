(() => {
  ...
  const pages = {
    "/": {
      ...
      "Belgelerinizi düzenleyin, önemli tarihleri zamanında hatırlayın. Sözleşmelerinizi, poliçelerinizi, garanti belgelerinizi, araç evraklarınızı ve takip etmek istediğiniz diğer belgeleri tek yerde yönetin.": "Organize your documents and get timely reminders for important dates. Manage your contracts, insurance policies, warranty documents, vehicle records, and any other documents you want to track in one place.",
    ...
    "/vaultify/": {
      ...
      "Belgelerinizi düzenleyin, önemli tarihleri zamanında hatırlayın. Sözleşme, poliçe, garanti belgesi ve diğer evraklarınızı tek yerde yönetin.": "Organize your documents and get timely reminders for important dates. Manage contracts, insurance policies, warranty documents, and other records in one place.",
      "Belgelerinizi düzenleyin, önemli tarihleri zamanında hatırlayın.": "Organize your documents and get timely reminders for important dates.",
      "Belge asistanı · Yakında · Yalnızca Android": "Document assistant · Coming soon · Android only",
      "Vaultify: Belge Asistanı": "Vaultify: Document Assistant",
      "Belgelerinizi düzenleyin, önemli tarihleri zamanında hatırlayın. Vaultify; sözleşmelerinizi, poliçelerinizi, garanti belgelerinizi, araç evraklarınızı ve takip etmek istediğiniz diğer belgeleri tek yerde düzenlemenize yardımcı olan kişisel belge asistanıdır.": "Organize your documents and get timely reminders for important dates. Vaultify is a personal document assistant that helps you organize contracts, insurance policies, warranty documents, vehicle records, and any other documents you want to track in one place.",
      "Yakında": "Coming soon",
      "Vaultify belge kasası görseli": "Vaultify document assistant illustration",
      "ÇEVRİMDIŞI": "OFFLINE",
      "GARANTİ": "WARRANTY",
      ...
      "İhtiyacınıza göre düzenleyin": "Organize it around your needs",
      "Hazır formatları kullanın veya kendi belge yapınızı oluşturun.": "Use ready-made formats or create your own document structure.",
      "Belgelerinizi kendi klasörlerinizde saklayın; tarih, açıklama, parasal değer, sayı ve birim gibi alanları ihtiyacınıza göre ekleyip sıralayın.": "Store documents in your own folders, then add and arrange fields such as dates, descriptions, monetary values, numbers, and units to suit your needs.",
      "Farklı kaynaklardan belge ekleme": "Add documents from different sources",
      "Kamera, galeri veya dosyalardan belge ekleyin.": "Add documents from the camera, gallery, or files.",
      "Özel klasörler ve formatlar": "Custom folders and formats",
      "Hazır formatlardan yararlanın veya kendi belge formatınızı oluşturun.": "Use ready-made formats or create your own document format.",
      "Birden fazla hatırlatıcı": "Multiple reminders",
      "Her belge için önemli tarihlere yönelik birden fazla hatırlatıcı oluşturun.": "Create multiple reminders for important dates on each document.",
      "Durum ve tarih takibi": "Status and date tracking",
      "Garanti, poliçe, araç muayenesi ve diğer önemli tarihleri takip edin.": "Track warranties, insurance policies, vehicle inspections, and other important dates.",
      "İlgili bilgiler": "Related information",
      "Belgeyle ilişkili kişi, kurum ve açıklamaları kaydedin.": "Save related people, organizations, and descriptions.",
      "Kronolojik süreç notları": "Chronological progress notes",
      "Belgeyle ilgili gelişmeleri tarih sırasıyla kaydedin.": "Record document-related updates in chronological order.",
      "Kapsamlı arama": "Comprehensive search",
      "Belge adı, özel alanlar ve süreç notları içerisinde arama yapın.": "Search within document names, custom fields, and progress notes.",
      ...
      "Belgeleriniz düzenli, önemli tarihleriniz kontrolünüz altında.": "Your documents stay organized, and your important dates remain under control.",
      "Vaultify’ı kullanmak için hesap veya sürekli internet bağlantısı gerekmez. Yedeklerinizi ne zaman ve nereye aktaracağınıza siz karar verirsiniz.": "Vaultify does not require an account or a continuous internet connection. You decide when and where to export your backups.",
